  ...
  return (
    ...
    >
      <View className="flex-1 justify-center items-center bg-black/50">
        <ThemedView
          darkColor="#242427"
          className="w-5/6 rounded-2xl  p-5  items-center"
        >
          ...
          <View className="flex-row gap-x-[-10] justify-between w-full border-t border-gray-600 pt-4">
            <Pressable
              className="px-5  ml-5 items-center justify-center py-2"
              onPress={onClose}
            >
              <ThemedText className="text-gray-400 text-center text-base">
                Cancel
              </ThemedText>
            </Pressable>
            <Pressable
              className="px-5 border-l border-gray-600 pl-[60]  mr-7 py-2"
              onPress={onClose}
            >
              <ThemedText
                bold
